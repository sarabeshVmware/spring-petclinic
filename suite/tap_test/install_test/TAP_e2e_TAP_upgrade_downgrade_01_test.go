...
func TestTapUgradeDowngrade(t *testing.T) {
	...
	testenv.Test(t,
		...
		common_features.UpdateTapProfileSupplyChain(t, suiteConfig.Tap.Name, suiteConfig.Tap.PackageName, suiteConfig.Tap.Version, "full", "basic", suiteConfig.Tap.Namespace),
		...
		//tap update
		common_features.UpgradeTapVersion(t, suiteConfig.Tap.Name, suiteConfig.Tap.PackageName, suiteConfig.PackageRepository.Name, suiteConfig.PackageRepository.UpdateImage, suiteConfig.Tap.Namespace, suiteConfig.Tap.UpdateVersion, suiteConfig.Tap.PollTimeout),
		...
		common_features.OuterloopCleanUp(t, outerloopConfig.Workload.YamlFile, outerloopConfig.Namespace),
