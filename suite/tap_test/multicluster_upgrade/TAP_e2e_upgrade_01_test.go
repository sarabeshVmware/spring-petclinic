...
func TestTapUpgrade(t *testing.T) {
	...
	//crud tests
	common_tests.Outerloop_basic_supplychain_test(t, testenv, suiteConfig, OuterloopConfig)
	...
	// multicluster_innerloop_test.TestMulticlusterInnerloopBasicSupplychainLocalSource(t)
	// testenv.Test(t,
	// 	common_featues.UpdatePackageRepository(t, suiteConfig.PackageRepository.Name, suiteConfig.UpgradeVersions.Image, suiteConfig.UpgradeVersions.TapRepoVersion, suiteConfig.Tap.Namespace),
