    ...
    cases = [
        {
            ...
            'expected': lambda result: result.backend.host == 'appliveview.example.com',
        ...
        },
        {
            ...
            'expected': lambda result: (result.backend.sslDisabled == 'false' and
                                        result.backend.host ==  'appliveview.example.com'),
        ...
        },
        {
            ...
            'expected': lambda result: (result.backend.sslDisabled == 'false' and
                                        result.backend.host ==  'domain-xyz.com'),
        ...
        },
        {
            ...
            'expected': lambda result: (result.backend.sslDisabled == 'false'),
