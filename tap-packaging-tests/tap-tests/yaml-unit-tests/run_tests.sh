...
ln -sf ../../../../tap-pkg/config/app-accelerator.yaml $component_to_test
...
echo -e "-----"
# can only load files a file with a `.lib.yaml` or `.star` extension.
ln -sf ../../../../tap-pkg/config/app-live-view-connector.yaml $component_to_test
...
echo -e "-----"
# can only load files a file with a `.lib.yaml` or `.star` extension.
ln -sf ../../../../tap-pkg/config/app-live-view.yaml $component_to_test
...
echo -e "-----"
# can only load files a file with a `.lib.yaml` or `.star` extension.
ln -sf ../../../../tap-pkg/config/cloud-native-runtimes.yaml $component_to_test
...
echo -e "-----"
# can only load files a file with a `.lib.yaml` or `.star` extension.
ln -sf ../../../../tap-pkg/config/learning-center.yaml $component_to_test
...
echo -e "-----"
# can only load files a file with a `.lib.yaml` or `.star` extension.
ln -sf ../../../../tap-pkg/config/tap-gui.yaml $component_to_test
