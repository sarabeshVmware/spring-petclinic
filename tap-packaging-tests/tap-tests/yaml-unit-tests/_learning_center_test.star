    ...
    cases = [
        {
            ...
            'expected': lambda result: (result.ingressDomain == 'learningcenter.example.com'),
        ...
        },
        {
            ...
            'expected': lambda result: (result.someKey == 'someValue' and
                                        result.ingressDomain == 'learningcenter.example.com'),
        ...
        },
        {
            ...
            'expected': lambda result: (result.ingressDomain == 'domain-xyz.com'),
